        ...
        <ul>
          ...
          <li
            ...
            >
              <div class="animate-v">
                <img
                  src="{{asset('assets/frontend/images/main-slider/slider-1/milk.png')}}"
                  alt=""
            ...
            >
              <div class="aon-banner-top-left-pic">
                <img src="{{asset('assets/frontend/images/main-slider/slider-1/cow.png')}}" alt="" />
          ...
          >
            ...
            <img
              src="{{asset('assets/frontend/images/main-slider/slider-1/image-2.jpg')}}"
              alt=""
              data-lazyload="{{asset('assets/frontend/images/main-slider/slider-1/image-2.jpg')}}"
              data-bgposition="center center"
              data-kenburns="on"
              data-duration="10000"
              data-ease="Power1.easeOut"
            ...
            >
              <div class="animate-v">
                <img
                  src="{{asset('assets/frontend/images/wetaly/182.jpg')}}"
                  alt=""
                  data-ww="['391px','280px','150px','150px']"
                  data-hh="['280px','249px','175px','175px']"
                  width="537"
                  height="691"
                  data-no-retina
                />
            ...
            >
              <div class="aon-banner-top-left-pic">
                <img src="{{asset('assets/frontend/images/main-slider/slider-1/cow2.png')}}" alt="" />
                <div class="aon-banner-top-left-circle animte-plus"></div>
              </div>
            </div>
          </li>
