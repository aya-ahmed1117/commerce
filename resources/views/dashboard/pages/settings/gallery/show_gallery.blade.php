              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @if (count($Gallerys) > 0)
                             ...
                             @foreach ($Gallerys as $gallery=>$aID)
                             <tr>
                                 <th scope="row">{{$Gallerys = $gallery+1 }}</th>
                 ...
                 <td>
                    ...
                    <a type="button" class="btn btn-primary" href="{{route('update.gallery',$aID->id)}}">
                        Update
                      </a>
                    </td>

                 <td> <a href="{{ route('delete.gallery',$aID->id) }}" class="btn btn-danger" id="delete">Delete</a></td>
