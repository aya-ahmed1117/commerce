          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">Footers</h3>

                    <div class="card-tools">
                        <div class="input-group-append">
                            <a href="{{route('store.footer')}}">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        @if (count($Footers) > 0)
                             ...
                             @foreach ($Footers as $footer=>$aID)
                             <tr>
                                <td scope="row">{{$Footers = $footer+1 }}</td>
                                <td>{{$aID->name}}</td>
                                <td>{{$aID->link}}</td>
                                <td>
                                    <div class="media">
                                ...
                                <td>
                                    <a type="button" class="btn btn-primary" href="{{route('update.footer',$aID->id)}}">
                                        Update
                                    </a>
                                </td>

                                <td> <a href="{{ route('delete.footer',$aID->id) }}" class="btn btn-danger" id="delete">
                                    Delete</a>
                                </td>
